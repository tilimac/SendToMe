...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$_REQUEST['folder'].'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/'.$_REQUEST['folder'].'/',
            'upload_url' => $this->get_full_url().'/'.$_REQUEST['folder'].'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
